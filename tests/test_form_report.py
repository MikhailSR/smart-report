...
class TestFormatNumberWithSpaces(unittest.TestCase):
    def test_integer(self):
        self.assertEqual(form_report.format_number_with_spaces(100), "100")
        self.assertEqual(form_report.format_number_with_spaces(1000), '1 000')
        self.assertEqual(form_report.format_number_with_spaces(120345), '120 345')

    def test_float(self):
        self.assertEqual(form_report.format_number_with_spaces(100.5), "100,5")
        self.assertEqual(form_report.format_number_with_spaces(1000.5), "1 000,5")
        self.assertEqual(form_report.format_number_with_spaces(10000.5), "10 000,5")
        self.assertEqual(form_report.format_number_with_spaces(100.0), "100")
        self.assertEqual(form_report.format_number_with_spaces(10000.0), "10 000")
