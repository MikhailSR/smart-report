import unittest
import app as test_file


class TestExstractBasename(unittest.TestCase):
    def tests_exstract(self):
        self.assertEqual(test_file.exstract_basename(
            '/tests/ОТДЕЛ ПРОДАЖ - Сентябрь.csv'),
            'ОТДЕЛ ПРОДАЖ - Сентябрь.csv')
        self.assertEqual(test_file.exstract_basename('D:\Work & Projects\Programming_projects'),
...
class TestIsCSVFile(unittest.TestCase):
    def tests(self):
        self.assertFalse(test_file.is_csv_file(''))
        self.assertFalse(test_file.is_csv_file('D:\Work & Projects\Programming_projects'), False)
        self.assertFalse(test_file.is_csv_file('ОТДЕЛ ПРОДАЖ - Сентябрь.json'), False)
        self.assertTrue(test_file.is_csv_file('ОТДЕЛ ПРОДАЖ - Сентябрь.csv'), True)
        self.assertTrue(test_file.is_csv_file('/tests/ОТДЕЛ ПРОДАЖ - Сентябрь.csv'), True)
